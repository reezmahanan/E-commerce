...
// Mirrors the allowed-origins logic used for the Express REST API in server.js,
// so the Socket.IO CORS policy stays consistent with the rest of the backend.
